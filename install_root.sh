...
chown -R $USERNAME:$USERNAME /home/$USERNAME/repos/linux-firmware/
make install
make dedup
update-initramfs -u -k all
git clone https://github.com/vim/vim.git /home/$USERNAME/repos/vim
cd /home/$USERNAME/repos/vim
chown -R $USERNAME:$USERNAME /home/$USERNAME/repos/vim/
