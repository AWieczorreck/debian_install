...
return {
  ...
  -- Trouble (Diagnostics & LSP Errors)
  {
    ...
    config = function()
      ...
      vim.keymap.set("n", "<leader>xw", "<cmd>Trouble diagnostics toggle filter.severity=nil<CR>",
      ...
      vim.keymap.set("n", "<leader>xn", "<cmd>Trouble next<CR>", { noremap = true, silent = true, desc = "Next Trouble" })
      vim.keymap.set("n", "<leader>xp", "<cmd>Trouble prev<CR>",
